...
interface MedicineForRudolphVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const MedicineForRudolphVisualization: FC<MedicineForRudolphVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Medicine for Rudolph Visualization</div>
...
export default MedicineForRudolphVisualization
