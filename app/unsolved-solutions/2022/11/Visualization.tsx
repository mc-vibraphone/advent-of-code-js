...
interface MonkeyInTheMiddleVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const MonkeyInTheMiddleVisualization: FC<MonkeyInTheMiddleVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Monkey in the Middle Visualization</div>
...
export default MonkeyInTheMiddleVisualization
