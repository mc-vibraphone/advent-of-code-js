...
interface ScienceForHungryPeopleVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const ScienceForHungryPeopleVisualization: FC<ScienceForHungryPeopleVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Science for Hungry People Visualization</div>
...
export default ScienceForHungryPeopleVisualization
