...
interface AuntSueVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const AuntSueVisualization: FC<AuntSueVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Aunt Sue Visualization</div>
...
export default AuntSueVisualization
