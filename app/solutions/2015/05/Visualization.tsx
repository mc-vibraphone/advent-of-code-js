...
interface DoesntHeHaveInternElvesForThisVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const DoesntHeHaveInternElvesForThisVisualization: FC<DoesntHeHaveInternElvesForThisVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Doesn't He Have Intern-Elves For This? Visualization</div>
...
export default DoesntHeHaveInternElvesForThisVisualization
