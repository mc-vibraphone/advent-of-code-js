...
interface CorporatePolicyVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const CorporatePolicyVisualization: FC<CorporatePolicyVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Corporate Policy Visualization</div>
...
export default CorporatePolicyVisualization
