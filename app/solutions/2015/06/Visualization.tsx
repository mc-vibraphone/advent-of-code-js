...
interface ProbablyAFireHazardVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const ProbablyAFireHazardVisualization: FC<ProbablyAFireHazardVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Probably a Fire Hazard Visualization</div>
...
export default ProbablyAFireHazardVisualization
