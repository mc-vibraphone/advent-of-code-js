...
interface AllInASingleNightVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const AllInASingleNightVisualization: FC<AllInASingleNightVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> All in a Single Night Visualization</div>
...
export default AllInASingleNightVisualization
