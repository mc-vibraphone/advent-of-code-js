...
interface ReindeerOlympicsVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const ReindeerOlympicsVisualization: FC<ReindeerOlympicsVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Reindeer Olympics Visualization</div>
...
export default ReindeerOlympicsVisualization
