...
interface NotQuiteLispVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const NotQuiteLispVisualization: FC<NotQuiteLispVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Not Quite Lisp Visualization</div>
...
export default NotQuiteLispVisualization
