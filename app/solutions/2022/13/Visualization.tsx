...
interface DistressSignalVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const DistressSignalVisualization: FC<DistressSignalVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Distress Signal Visualization</div>
...
export default DistressSignalVisualization
