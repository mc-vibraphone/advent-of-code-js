...
interface GrovePositioningSystemVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const GrovePositioningSystemVisualization: FC<GrovePositioningSystemVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Grove Positioning System Visualization</div>
...
export default GrovePositioningSystemVisualization
