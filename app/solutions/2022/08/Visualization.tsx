...
interface TreetopTreeHouseVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const TreetopTreeHouseVisualization: FC<TreetopTreeHouseVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Treetop Tree House Visualization</div>
...
export default TreetopTreeHouseVisualization
