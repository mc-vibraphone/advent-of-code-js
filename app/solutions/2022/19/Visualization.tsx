...
interface NotEnoughMineralsVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const NotEnoughMineralsVisualization: FC<NotEnoughMineralsVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Not Enough Minerals Visualization</div>
...
export default NotEnoughMineralsVisualization
