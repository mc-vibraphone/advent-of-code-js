...
interface PassagePathingVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const PassagePathingVisualization: FC<PassagePathingVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Passage Pathing Visualization</div>
...
export default PassagePathingVisualization
