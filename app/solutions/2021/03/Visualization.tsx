...
interface BinaryDiagnosticVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const BinaryDiagnosticVisualization: FC<BinaryDiagnosticVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Binary Diagnostic Visualization</div>
...
export default BinaryDiagnosticVisualization
