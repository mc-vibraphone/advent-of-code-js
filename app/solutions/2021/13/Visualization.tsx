...
interface TransparentOrigamiVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const TransparentOrigamiVisualization: FC<TransparentOrigamiVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Transparent Origami Visualization</div>
...
export default TransparentOrigamiVisualization
