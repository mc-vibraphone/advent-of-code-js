...
interface LanternfishVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const LanternfishVisualization: FC<LanternfishVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Lanternfish Visualization</div>
...
export default LanternfishVisualization
