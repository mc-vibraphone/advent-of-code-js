...
interface ExtendedPolymerizationVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const ExtendedPolymerizationVisualization: FC<ExtendedPolymerizationVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Extended Polymerization Visualization</div>
...
export default ExtendedPolymerizationVisualization
