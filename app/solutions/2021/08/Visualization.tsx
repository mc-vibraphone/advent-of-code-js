...
interface SevenSegmentSearchVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const SevenSegmentSearchVisualization: FC<SevenSegmentSearchVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Seven Segment Search Visualization</div>
...
export default SevenSegmentSearchVisualization
