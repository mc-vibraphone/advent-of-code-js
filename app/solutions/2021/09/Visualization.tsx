...
interface SmokeBasinVisualizationProps {
  componentInfo: VisualizationComponentInfo
}

const SmokeBasinVisualization: FC<SmokeBasinVisualizationProps> = ({
  componentInfo,
}) => {
  ...
  return (
    <div className="h-full">
      <div> Smoke Basin Visualization</div>
...
export default SmokeBasinVisualization
